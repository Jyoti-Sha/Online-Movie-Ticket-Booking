...
--
-- Host: localhost
-- Generation Time: Nov 19, 2018 at 03:44 PM
...
CREATE TABLE IF NOT EXISTS `emp` (
  ...
  `emphobby` varchar(50) NOT NULL,
  `empcity` varchar(50) NOT NULL,
  `empadds` varchar(50) NOT NULL,
  PRIMARY KEY (`empid`)
...
INSERT INTO `emp` (`empid`, `empname`, `empgender`, `emphobby`, `empcity`, `empadds`) VALUES
(16, 'Abhishek sharma', 'male', 'reading histoticial', 'ballia', 'ballia'),
(15, 'rama gupta', 'female', 'cricket ,', 'ballia', 'ballia'),
(7, 'rani verma', 'female', 'cricket , ', 'ballia', 'ballia'),
(8, 'Anshika Singh', 'female', 'dancing', 'lucknow', 'ballia'),
(9, 'rama', 'female', 'dancing', 'rampur', 'baliia'),
(10, 'gopal', 'male', 'reading histoticial , cricket', '', 'lucknow'),
(11, 'vivek sharma', 'male', 'reading histoticial , cricket', '', 'ballia'),
(12, 'aditya sharma', 'male', 'hockey , reading histoticial , cricket', '', 'ballia'),
(13, 'aditya sharma', 'male', 'hockey , reading histoticial , cricket', '', 'ballia'),
(14, 'rajat sharma', 'male', 'reading histoticial , cricket , hockey', '', 'ballia'),
(17, 'Sajal sandiliya', 'female', 'reading histoticial', '', 'ballia'),
(18, 'coco', 'female', 'dancing', 'lucknow', 'lucknow'),
(19, 'kajal', 'female', 'hockey', 'ballia', 'bllia');
--
...
(NULL, 'employee', 'emp', 'empid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'employee', 'emp', 'empname', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'employee', 'emp', 'empgender', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'employee', 'emp', 'emphobby', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'employee', 'emp', 'empcity', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'employee', 'emp', 'empadds', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'forid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'forname', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'foremail', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'forpassword', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'forgender', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'forhobby', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'forcity', 7, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'foraddress', 8, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'forimage', 9, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'jyoti', 'sharma', 'formobile', 10, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(13)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'adminlogin', 'adminid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'adminlogin', 'adminemail', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'adminlogin', 'adminpassword', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'contact', 'contid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'contact', 'contname', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'contact', 'contemail', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'contact', 'contmobile', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'contact', 'contaddress', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'contact', 'contmassage', 6, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'contact', 'contdatetime', 7, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'login', 'logid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'login', 'logemail', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'login', 'logpassword', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'login', 'logdatetime', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'login', 'logoutdatetime', 5, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'login', 'logstatus', 6, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'city', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'theatername', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'theatertype', 4, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'moviename', 5, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'movietype', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'timings', 7, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'datetime', 8, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'movieticket', 'shows', 9, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'regid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'regname', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'regemail', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'regpassword', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'regmobile', 5, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'reggender', 6, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'regcity', 7, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'regaddress', 8, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'movietickect', 'registration', 'regdatetime', 9, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
...
(NULL, 'php11', 'form', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'php11', 'form', 'username', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'form', 'userfname', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'form', 'usermname', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'form', 'useremail', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'form', 'userpass', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'form', 'usernum', 7, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'image', 'imageid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'php11', 'image', 'imagename', 2, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'image', 'imagedatetime', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'login', 'logid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'php11', 'login', 'logemail', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'login', 'logpass', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'login', 'logdatetime', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'login', 'logoutdatetime', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'login', 'logcount', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'login', 'logstatus', 7, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'registration', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(7)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'php11', 'registration', 'name', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'registration', 'email', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'registration', 'password', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'registration', 'mobile', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'php11', 'registration', 'datetime', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'software', 'form', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'software', 'form', 'username', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'software', 'form', 'useremail', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'software', 'form', 'userpass', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'software', 'form', 'userdate', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'software', 'form', 'useradds', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'software', 'form', 'usergen', 7, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'software', 'form', 'userhob', 8, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', '');
...
('THREADS_RUNNING', '1'),
('UPTIME', '3198381'),
('UPTIME_SINCE_FLUSH_STATUS', '3198381');
...
('RAND_SEED1', ''),
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DESKTOP-AFDPQTG-slow.log'),
...
('THREAD_STACK', '262144'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DESKTOP-AFDPQTG.log'),
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DESKTOP-AFDPQTG.pid'),
('EXPIRE_LOGS_DAYS', '0'),
('NAMED_PIPE', 'OFF'),
...
(NULL, 'employee', 'PRIMARY', NULL, 'employee', 'emp', 'empid', 1, NULL, NULL, NULL, NULL),
(NULL, 'jyoti', 'PRIMARY', NULL, 'jyoti', 'sharma', 'forid', 1, NULL, NULL, NULL, NULL),
(NULL, 'movietickect', 'PRIMARY', NULL, 'movietickect', 'adminlogin', 'adminid', 1, NULL, NULL, NULL, NULL),
(NULL, 'movietickect', 'PRIMARY', NULL, 'movietickect', 'contact', 'contid', 1, NULL, NULL, NULL, NULL),
(NULL, 'movietickect', 'PRIMARY', NULL, 'movietickect', 'login', 'logid', 1, NULL, NULL, NULL, NULL),
(NULL, 'movietickect', 'PRIMARY', NULL, 'movietickect', 'movieticket', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'movietickect', 'PRIMARY', NULL, 'movietickect', 'registration', 'regid', 1, NULL, NULL, NULL, NULL),
...
(NULL, 'php11', 'PRIMARY', NULL, 'php11', 'form', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'php11', 'PRIMARY', NULL, 'php11', 'image', 'imageid', 1, NULL, NULL, NULL, NULL),
(NULL, 'php11', 'PRIMARY', NULL, 'php11', 'login', 'logid', 1, NULL, NULL, NULL, NULL),
(NULL, 'php11', 'PRIMARY', NULL, 'php11', 'registration', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'software', 'PRIMARY', NULL, 'software', 'form', 'id', 1, NULL, NULL, NULL, NULL);
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, NULL, '', '', NULL),
(NULL, 'employee', 'emp', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 66, 868, 281474976710655, 2048, 0, '2018-07-19 22:21:07', '2018-07-20 11:23:55', NULL, NULL, '', '', NULL),
(NULL, 'jyoti', 'sharma', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 127, 636, 281474976710655, 2048, 0, '2018-07-21 19:45:23', '2018-07-22 09:24:57', NULL, NULL, '', '', NULL),
(NULL, 'movietickect', 'adminlogin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 64, 160, 281474976710655, 2048, 96, '2018-07-29 03:15:20', '2018-08-03 17:24:22', NULL, NULL, '', '', NULL),
(NULL, 'movietickect', 'contact', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 98, 196, 281474976710655, 2048, 0, '2018-08-01 23:14:40', '2018-08-28 15:59:14', NULL, NULL, '', '', NULL),
(NULL, 'movietickect', 'login', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 72, 364, 281474976710655, 2048, 0, '2018-07-28 10:36:43', '2018-10-20 11:36:46', NULL, NULL, '', '', NULL),
(NULL, 'movietickect', 'movieticket', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 70, 180, 281474976710655, 2048, 40, '2018-08-03 18:18:01', '2018-08-04 10:23:46', NULL, NULL, '', '', NULL),
(NULL, 'movietickect', 'registration', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 94, 1044, 281474976710655, 2048, 0, '2018-07-28 10:31:27', '2018-10-20 11:22:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2010-11-03 19:52:43', '2010-11-24 15:00:18', '2010-11-03 19:52:44', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2010-11-03 19:52:43', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 452, 197, 89044, 55450570411999231, 16384, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 993, 9, 8937, 2533274790395903, 17408, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 506, 847, 428880, 281474976710655, 20480, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2010-11-03 19:52:43', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2010-11-03 19:52:43', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 50, 152, 281474976710655, 2048, 0, '2010-11-03 19:52:43', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'php11', 'form', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 64, 640, 281474976710655, 2048, 0, '2018-07-15 10:53:14', '2018-07-16 00:55:19', NULL, NULL, '', '', NULL),
(NULL, 'php11', 'image', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 52, 420, 281474976710655, 2048, 0, '2018-07-19 10:47:52', '2018-07-21 10:00:43', NULL, NULL, '', '', NULL),
(NULL, 'php11', 'login', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 61, 308, 281474976710655, 2048, 0, '2018-07-21 10:06:53', '2018-07-28 11:09:44', NULL, NULL, '', '', NULL),
(NULL, 'php11', 'registration', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 77, 544, 281474976710655, 2048, 0, '2018-07-21 10:00:26', '2018-07-28 11:09:44', NULL, NULL, '', '', NULL),
(NULL, 'software', 'form', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 80, 160, 281474976710655, 2048, 0, '2018-07-18 11:31:34', '2018-07-20 01:07:57', NULL, NULL, '', '', NULL);
...
(113, 'root', 'localhost:61663', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'employee', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'jyoti', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'movietickect', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'php11', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'software', 'latin1', 'latin1_swedish_ci', NULL);
...
(NULL, 'employee', 'emp', 0, 'employee', 'PRIMARY', 1, 'empid', 'A', 13, NULL, NULL, '', 'BTREE', ''),
(NULL, 'jyoti', 'sharma', 0, 'jyoti', 'PRIMARY', 1, 'forid', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'movietickect', 'adminlogin', 0, 'movietickect', 'PRIMARY', 1, 'adminid', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'movietickect', 'contact', 0, 'movietickect', 'PRIMARY', 1, 'contid', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'movietickect', 'login', 0, 'movietickect', 'PRIMARY', 1, 'logid', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'movietickect', 'movieticket', 0, 'movietickect', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'movietickect', 'registration', 0, 'movietickect', 'PRIMARY', 1, 'regid', 'A', 11, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'php11', 'form', 0, 'php11', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'php11', 'image', 0, 'php11', 'PRIMARY', 1, 'imageid', 'A', 8, NULL, NULL, '', 'BTREE', ''),
(NULL, 'php11', 'login', 0, 'php11', 'PRIMARY', 1, 'logid', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'php11', 'registration', 0, 'php11', 'PRIMARY', 1, 'id', 'A', 7, NULL, NULL, '', 'BTREE', ''),
(NULL, 'software', 'form', 0, 'software', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-19 21:14:34', '2018-11-19 21:14:34', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'employee', 'emp', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 13, 66, 868, 281474976710655, 2048, 0, 20, '2018-07-19 22:21:07', '2018-07-20 11:23:55', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'jyoti', 'sharma', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 127, 636, 281474976710655, 2048, 0, 6, '2018-07-21 19:45:23', '2018-07-22 09:24:57', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'movietickect', 'adminlogin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 64, 160, 281474976710655, 2048, 96, 7, '2018-07-29 03:15:20', '2018-08-03 17:24:22', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'movietickect', 'contact', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 98, 196, 281474976710655, 2048, 0, 3, '2018-08-01 23:14:40', '2018-08-28 15:59:14', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'movietickect', 'login', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 72, 364, 281474976710655, 2048, 0, 13, '2018-07-28 10:36:43', '2018-10-20 11:36:46', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'movietickect', 'movieticket', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 70, 180, 281474976710655, 2048, 40, 4, '2018-08-03 18:18:01', '2018-08-04 10:23:46', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'movietickect', 'registration', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 11, 94, 1044, 281474976710655, 2048, 0, 13, '2018-07-28 10:31:27', '2018-10-20 11:22:47', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2010-11-03 19:52:43', '2010-11-24 15:00:18', '2010-11-03 19:52:44', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2010-11-03 19:52:43', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 452, 197, 89044, 55450570411999231, 16384, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 993, 9, 8937, 2533274790395903, 17408, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 506, 847, 428880, 281474976710655, 20480, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2010-11-03 19:52:43', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2010-11-03 19:52:43', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2010-11-03 19:52:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 50, 152, 281474976710655, 2048, 0, NULL, '2010-11-03 19:52:43', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'php11', 'form', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 10, 64, 640, 281474976710655, 2048, 0, 11, '2018-07-15 10:53:14', '2018-07-16 00:55:19', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'php11', 'image', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 52, 420, 281474976710655, 2048, 0, 17, '2018-07-19 10:47:52', '2018-07-21 10:00:43', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'php11', 'login', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 61, 308, 281474976710655, 2048, 0, 8, '2018-07-21 10:06:53', '2018-07-28 11:09:44', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'php11', 'registration', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 7, 77, 544, 281474976710655, 2048, 0, 8, '2018-07-21 10:00:26', '2018-07-28 11:09:44', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'software', 'form', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 80, 160, 281474976710655, 2048, 0, 6, '2018-07-18 11:31:34', '2018-07-20 01:07:57', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'employee', 'PRIMARY', 'employee', 'emp', 'PRIMARY KEY'),
(NULL, 'jyoti', 'PRIMARY', 'jyoti', 'sharma', 'PRIMARY KEY'),
(NULL, 'movietickect', 'PRIMARY', 'movietickect', 'adminlogin', 'PRIMARY KEY'),
(NULL, 'movietickect', 'PRIMARY', 'movietickect', 'contact', 'PRIMARY KEY'),
(NULL, 'movietickect', 'PRIMARY', 'movietickect', 'login', 'PRIMARY KEY'),
(NULL, 'movietickect', 'PRIMARY', 'movietickect', 'movieticket', 'PRIMARY KEY'),
(NULL, 'movietickect', 'PRIMARY', 'movietickect', 'registration', 'PRIMARY KEY'),
...
(NULL, 'php11', 'PRIMARY', 'php11', 'form', 'PRIMARY KEY'),
(NULL, 'php11', 'PRIMARY', 'php11', 'image', 'PRIMARY KEY'),
(NULL, 'php11', 'PRIMARY', 'php11', 'login', 'PRIMARY KEY'),
(NULL, 'php11', 'PRIMARY', 'php11', 'registration', 'PRIMARY KEY'),
(NULL, 'software', 'PRIMARY', 'software', 'form', 'PRIMARY KEY');
...
-- Database: `jyoti`
--
CREATE DATABASE `jyoti` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `jyoti`;

-- --------------------------------------------------------

--
-- Table structure for table `sharma`
--

CREATE TABLE IF NOT EXISTS `sharma` (
  `forid` int(5) NOT NULL AUTO_INCREMENT,
  `forname` varchar(50) NOT NULL,
  `foremail` varchar(50) NOT NULL,
  `forpassword` varchar(50) NOT NULL,
  `forgender` varchar(50) NOT NULL,
  `forhobby` varchar(50) NOT NULL,
  `forcity` varchar(50) NOT NULL,
  `foraddress` varchar(50) NOT NULL,
  `forimage` varchar(50) NOT NULL,
  `formobile` int(13) NOT NULL,
  PRIMARY KEY (`forid`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `sharma`
--

INSERT INTO `sharma` (`forid`, `forname`, `foremail`, `forpassword`, `forgender`, `forhobby`, `forcity`, `foraddress`, `forimage`, `formobile`) VALUES
(1, 'ghv', 'abhi43@gmail.com', '098765', 'female', 'hockey , reading histoticial', 'rampur', 'dfghujiol;', 'IMG_20180617_181131958.jpg', 2345678),
(2, 'abhi sharma', 'abhi43@gmail.com', '12345', 'male', 'hockey , reading histoticial , cricket', 'ballia', 'ballia', 'abhi.jpg', 234567890),
(3, 'jyoti sharma', 'js5161940@gmail.com', '1234567', 'female', 'hockey , reading histoticial', 'ballia', 'ballia', 'IMG_20180618_113404159.jpg', 1234567890),
(4, 'sadhwi mishra', 'sadhwimishra30@gmail.com', '12345678', 'female', 'hockey , cricket , dancing', 'ballia', 'lucknow', 'IMG_20180617_182108474.jpg', 1234567890),
(5, 'Gauri soni', 'gs1234@gmail.com', '12345678', 'female', 'cricket , dancing , hockey', 'lucknow', 'ballia', 'IMG_20180618_165623598.jpg', 1234567890);
--
-- Database: `movietickect`
--
CREATE DATABASE `movietickect` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `movietickect`;
...
-- Database: `php11`
--
CREATE DATABASE `php11` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `php11`;
...
INSERT INTO `form` (`id`, `username`, `userfname`, `usermname`, `useremail`, `userpass`, `usernum`) VALUES
(1, 'rama gupta', 'narayan gupta', 'meera gupta', 'rama@gmail.com', '12345', '1234567890'),
(2, 'jyoti sharma', 'sanjay sharma', 'manorama sharma', '9877665', '1234', '876654'),
(3, 'sadhwi mishra', 'dhirendra mishra', 'sandhya mishra', 'kjjhh87766', '12345', '123456789'),
(4, 'Anshika yadav', 'Amarjeet yadav', 'MR.s yadav', 'as098@gamil.com', '12345', '1234567890'),
(5, 'Gauri soni', 'Mr.soni', 'Mrs.soni', 'gs1234@gmail.com', '12345', '1234567890'),
(6, 'Sajal sandiliya', 'Omnarayan updhaya', 'Garima updhaya', 'ss1234@gmail.com', '12345', '1234567890'),
(7, '', '', '', '', '', ''),
(8, '', '', '', '', '', ''),
(9, '', '', '', '', '', ''),
(10, 'sadhwi mishra', 'Manorama devi', 'manorama sharma', 'js5161940@gmail.com', '1256', '0962');
...
CREATE TABLE IF NOT EXISTS `image` (
  ...
  `imagedatetime` varchar(20) NOT NULL,
  PRIMARY KEY (`imageid`)
...
INSERT INTO `image` (`imageid`, `imagename`, `imagedatetime`) VALUES
(9, 'IMG_20180627_185446127.jpg', '19/07/18 11:30:05am'),
(11, 'abhi.jpg', '20/07/18 10:06:49am'),
(13, '', '20/07/18 07:43:39pm'),
(14, '', '20/07/18 07:44:22pm'),
(8, 'IMG_20180618_113404159.jpg', '19/07/18 11:29:53am'),
(6, 'IMG_20180626_123334133.jpg', '19/07/18 10:51:20am'),
(15, '', '20/07/18 12:05:01am'),
(16, '', '21/07/18 10:00:43am');
...
CREATE TABLE IF NOT EXISTS `login` (
  ...
  `logdatetime` varchar(50) NOT NULL,
  `logoutdatetime` varchar(50) NOT NULL,
  `logcount` varchar(50) NOT NULL,
...
INSERT INTO `login` (`logid`, `logemail`, `logpass`, `logdatetime`, `logoutdatetime`, `logcount`, `logstatus`) VALUES
(1, 'sadhwimishra30@gmail.com', '', '', '', '', ''),
(4, 'js5161940@gmail.com', '1234567', '22/07/18 11:44:13am', '22/07/18 10:59:21am', '', 'true'),
(5, 'as@gmail.com', '1234567', '22/07/18 10:30:42am', '', '', 'true'),
(6, 'gs1234@gmail.com', '12345', '22/07/18 10:34:27am', '', '', 'true'),
(7, 'hgfgf@gamil.com', '123', '', '', '', '');
...
INSERT INTO `registration` (`id`, `name`, `email`, `password`, `mobile`, `datetime`) VALUES
(1, 'sadhwi mishra', 'sadhwimishra30@gmail.com', '', '1234567890', '21/07/18 10:53:10am'),
(2, 'jyoti sharma', 'js5161940@gmail.com', '12345', '1234567890', '21/07/18 10:54:10am'),
(3, 'Gauri soni', 'js5161940@gmail.com', '12345', '1234567890', '21/07/18 11:07:46am'),
(4, 'Sajal sandiliya', 'js5161940@gmail.com', '1234567', '1234567890', '21/07/18 11:15:46am'),
(5, 'abhi sharma', 'as@gmail.com', '1234567', '1234567890', '21/07/18 11:21:34am'),
(6, 'Gauri soni', 'gs1234@gmail.com', '12345', '1234567890', '22/07/18 10:33:56am'),
(7, 'sadhwi mishra', 'hgfgf@gamil.com', '123', '11234567890', '28/07/18 11:09:43am');
--
-- Database: `software`
--
...
CREATE TABLE IF NOT EXISTS `form` (
  ...
  `useradds` varchar(30) NOT NULL,
  `usergen` varchar(15) NOT NULL,
  `userhob` varchar(10) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;
...
INSERT INTO `form` (`id`, `username`, `useremail`, `userpass`, `userdate`, `useradds`, `usergen`, `userhob`) VALUES
(3, 'jyoti sharma', 'js5161940@gmail.com', 1234567, '2018-07-10', 'sdsdffhnjmnbhg', 'on', 'on'),
(5, 'Abhishek sharma', 'abhi43@gmail.com', 1234567, '12-04-1997', 'nzjhsjhsjhjhsdkj', 'on', 'on');
